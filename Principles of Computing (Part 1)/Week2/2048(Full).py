...
# Change of drawing VAl1 or VAl2 on new tile - number shows chance of drawing VAl1
NEW_TILE_CHANCE = 90 # out of 100, can use 0 - 1 (we can use)
#available values of NEW tile
NEW_TILE_VAL1 = 2
NEW_TILE_VAL2 = 4
...
def merge(line):
    ...
    def slide(new_line):
        '''
        slides values leftwards into empty space
        '''
